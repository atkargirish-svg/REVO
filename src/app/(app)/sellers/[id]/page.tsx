    ...
    <PageTransitionWrapper className="container py-10">
      <div className="grid lg:grid-cols-3 gap-12">
        ...
        <div className="lg:col-span-2 space-y-12">
            <div>
                <h2 className="text-2xl font-bold font-headline mb-4">Available Waste Streams</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    {sellerProducts.length > 0 ? (
                        ...
                        <p className="text-muted-foreground col-span-full">This producer has no available waste streams right now.</p>
                    )}
                </div>
            </div>
        </div>
