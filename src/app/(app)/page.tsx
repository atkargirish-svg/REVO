      ...
      <section className="relative w-full h-[60vh] min-h-[400px] flex items-center justify-center text-center border-b overflow-hidden">
        ...
        <div className="relative container px-4">
            <div className="mx-auto max-w-4xl flex flex-col items-center gap-6 animate-fade-in-up">
                <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight font-headline bg-clip-text text-transparent bg-gradient-to-r from-white via-destructive to-white bg-200% animate-shine">
                    {t('home.hero.title')}
                </h1>
